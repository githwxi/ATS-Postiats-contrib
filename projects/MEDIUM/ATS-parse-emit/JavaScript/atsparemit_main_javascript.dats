...
dynload "./atsparemit_emit_javascript.dats"
...
prerrln!
(
  "Hello from ATS-parse-emit-javascript!"
) (* end of [val] *)
//
...
prerrln!
(
  "Good-bye from ATS-parse-emit-javascript!"
) (* end of [val] *)
//
} (* end of [main0] *)
...
(* end of [atsparemit_main_javascript.dats] *)
