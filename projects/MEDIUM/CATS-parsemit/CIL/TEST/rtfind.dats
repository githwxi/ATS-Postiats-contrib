...
//
extern
fun rtfind (f: int -> int): int = "ext#rtfindf"
//
implement
rtfind (f) = let
//
...
.entrypoint
//
ldstr "rtfind(lam x => x*x + x - 6) = "
call void [mscorlib]System.Console::Write(string)
ldnull
ldftn int32 Postiats.rtfind::poly0(int32)
newobj instance void class [mscorlib]System.Func`2<int32,int32>::.ctor(object, native int)
call int32 Postiats.rtfind::rtfindf([mscorlib]System.Delegate)
...
call void [mscorlib]System.Console::Write(string)
ldnull
ldftn int32 Postiats.rtfind::poly1(int32)
newobj instance void class [mscorlib]System.Func`2<int32,int32>::.ctor(object, native int)
call int32 Postiats.rtfind::rtfindf([mscorlib]System.Delegate)
call void [mscorlib]System.Console::Write(int32)
call void [mscorlib]System.Console::WriteLine()
//
ldstr "rtfind(lam x => x*x + 2*x - 99) = "
call void [mscorlib]System.Console::Write(string)
ldnull
ldftn int32 Postiats.rtfind::poly2(int32)
newobj instance void class [mscorlib]System.Func`2<int32,int32>::.ctor(object, native int)
call int32 Postiats.rtfind::rtfindf([mscorlib]System.Delegate)
call void [mscorlib]System.Console::Write(int32)
call void [mscorlib]System.Console::WriteLine()
...
call void [mscorlib]System.Console::Write(string)
ldnull
ldftn int32 Postiats.rtfind::poly3(int32)
newobj instance void class [mscorlib]System.Func`2<int32,int32>::.ctor(object, native int)
call int32 Postiats.rtfind::rtfindf([mscorlib]System.Delegate)
call void [mscorlib]System.Console::Write(int32)
call void [mscorlib]System.Console::WriteLine()
