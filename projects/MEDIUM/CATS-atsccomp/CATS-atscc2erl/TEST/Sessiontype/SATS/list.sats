...
fun
chanpos_list_cons
  {a:vt0p}(!chanpos(sslist(a)) >> chanpos(chsnd(a)::sslist(a))): void = "mac#%"
//
(* ****** ****** *)
//
fun
...
//
fun
list2sslist{a:t0p}(xs: List(a)): channeg(sslist(a))
fun
sslist2list{a:t0p}(chn: channeg(sslist(a))): List0(a)
//
fun
list2sslist_vt{a:vt0p}(xs: List_vt(a)): channeg(sslist(a))
fun
sslist2list_vt{a:vt0p}(chn: channeg(sslist(a))): List0_vt(a)
//
(* ****** ****** *)
